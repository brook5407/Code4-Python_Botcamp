...
async def on_message(message):
    ...
    if message.content == '$help':
      ...
      # **$greet - Greets user**
      # **$greetings - Greets user's nickname**
      # **$echo - Enables the bot to repeat the user’s message**
      # **$Say - Enables the bot to repeat the user’s message**
      # **$rock/$paper/$scissors (any) - Play a simple game of rock, paper scissors with the user**
      # """
      # embed = discord.Embed(title="Discord Bot Commands", description=help_cmd, color=0x00ff00)
